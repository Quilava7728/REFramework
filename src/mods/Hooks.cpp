...
std::optional<std::string> Hooks::hook_mhs3_waitrendering_callsites() {
    ...
    constexpr uintptr_t producer_object_loop_begin_marker_elapsed_rva = 0x03fee8a;
    constexpr uintptr_t producer_object_loop_end_marker_elapsed_rva   = 0x03fef06;

    m_mhs3_producer_object_loop_begin_marker_elapsed_hook =
        safetyhook::create_mid(
            (void*)(base + producer_object_loop_begin_marker_elapsed_rva),
            &Hooks::mhs3_producer_object_loop_begin_marker_elapsed
        );

    if (!m_mhs3_producer_object_loop_begin_marker_elapsed_hook) {
        return "Failed to install MHS3 Build #31G5 begin-marker-elapsed probe";
    }

    m_mhs3_producer_object_loop_end_marker_elapsed_hook =
        safetyhook::create_mid(
            (void*)(base + producer_object_loop_end_marker_elapsed_rva),
            &Hooks::mhs3_producer_object_loop_end_marker_elapsed
        );

    if (!m_mhs3_producer_object_loop_end_marker_elapsed_hook) {
        return "Failed to install MHS3 Build #31G5 end-marker-elapsed probe";
    }

    spdlog::info(
        "[MHS3 BUILD31G5] object-loop marker-elapsed probes installed: "
        "begin=0x{:x} end=0x{:x}",
        base + producer_object_loop_begin_marker_elapsed_rva,
        base + producer_object_loop_end_marker_elapsed_rva
    );
...
void Hooks::mhs3_producer_object_loop_begin_marker_elapsed(
...
void Hooks::mhs3_producer_object_loop_end_marker_elapsed(
    safetyhook::Context& context
) {
    (void)context;
