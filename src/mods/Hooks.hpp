...
private:
    ...
    // Build #31A:
    // Single begin-only probe at the Build #28 object-loop entry.
    static void mhs3_producer_object_loop_begin_only(
...
protected:
    ...
    // Build #31A: exactly one additional mid-hook.
    safetyhook::MidHook m_mhs3_producer_object_loop_begin_only_hook{};
