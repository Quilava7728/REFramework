...
private:
    ...
    // Build #31C:
    // Both object-loop hook locations active with intentionally trivial callbacks.
    static void mhs3_producer_object_loop_begin_empty(
        safetyhook::Context& context
    );
    static void mhs3_producer_object_loop_end_empty(
        safetyhook::Context& context
    );
...
protected:
    ...
    // Build #31C: both object-loop hooks, no timing/state work.
    safetyhook::MidHook m_mhs3_producer_object_loop_begin_empty_hook{};
    safetyhook::MidHook m_mhs3_producer_object_loop_end_empty_hook{};
