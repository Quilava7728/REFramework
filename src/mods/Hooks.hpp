...
private:
    ...
    // Build #31F:
    // Pair the two object-loop timestamps and compute elapsed time.
    static void mhs3_producer_object_loop_begin_elapsed(
        safetyhook::Context& context
    );
    static void mhs3_producer_object_loop_end_elapsed(
        safetyhook::Context& context
    );
...
protected:
    ...
    // Build #31F.
    safetyhook::MidHook m_mhs3_producer_object_loop_begin_elapsed_hook{};
    safetyhook::MidHook m_mhs3_producer_object_loop_end_elapsed_hook{};
