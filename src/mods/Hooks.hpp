...
private:
    ...
    // Build #31G:
    // Pair object-loop timestamps and maintain minimal timing bookkeeping.
    static void mhs3_producer_object_loop_begin_bookkeeping(
        safetyhook::Context& context
    );
    static void mhs3_producer_object_loop_end_bookkeeping(
        safetyhook::Context& context
    );
...
protected:
    ...
    // Build #31G.
    safetyhook::MidHook m_mhs3_producer_object_loop_begin_bookkeeping_hook{};
    safetyhook::MidHook m_mhs3_producer_object_loop_end_bookkeeping_hook{};
