...
private:
    ...
    // Build #31G3:
    // Proven elapsed timing plus one TLS store only.
    static void mhs3_producer_object_loop_begin_tls_store(
        safetyhook::Context& context
    );
    static void mhs3_producer_object_loop_end_tls_store(
        safetyhook::Context& context
    );
...
protected:
    ...
    // Build #31G3.
    safetyhook::MidHook m_mhs3_producer_object_loop_begin_tls_store_hook{};
    safetyhook::MidHook m_mhs3_producer_object_loop_end_tls_store_hook{};
