...
private:
    ...
    static void mhs3_producer_object_loop_begin_marker_elapsed(
        safetyhook::Context& context
    );
    static void mhs3_producer_object_loop_end_marker_elapsed(
        safetyhook::Context& context
    );
...
protected:
    ...
    // Build #31G5.
    safetyhook::MidHook m_mhs3_producer_object_loop_begin_marker_elapsed_hook{};
    safetyhook::MidHook m_mhs3_producer_object_loop_end_marker_elapsed_hook{};
