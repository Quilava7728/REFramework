...
private:
    ...
    static void mhs3_producer_object_loop_begin_total(
        safetyhook::Context& context
    );
    static void mhs3_producer_object_loop_end_total(
        safetyhook::Context& context
    );
...
protected:
    ...
    // Build #31G2.
    safetyhook::MidHook m_mhs3_producer_object_loop_begin_total_hook{};
    safetyhook::MidHook m_mhs3_producer_object_loop_end_total_hook{};
